    ...
    <svg className="fluid-logo" viewBox="0 0 64 64" role="img" aria-label="Fluid logo">
      <defs>
        <linearGradient id="fluid-logo-bg" x1="0" y1="0" x2="1" y2="1">
          ...
          <stop offset="0.55" stopColor="#2997ff" />
      ...
      <path d="M19 25.5C23 21.5 27 21.5 31 25.5S39 29.5 45 25.5" fill="none" stroke="#2997ff" strokeWidth="4" strokeLinecap="round" />
      <path d="M19 33.5C23 29.5 27 29.5 31 33.5S39 37.5 45 33.5" fill="none" stroke="#00d4f0" strokeWidth="4" strokeLinecap="round" />
      <circle cx="52" cy="12" r="5" fill="#2dffc4" stroke="#000" strokeWidth="2" />
    </svg>
  );
}
